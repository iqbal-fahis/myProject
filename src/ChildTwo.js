    ...
    render(){ 
        ...
        return( 
                ...
                <form onSubmit={this.handleSubmit} >
                   <center><h1>Hi I am from Child Two</h1> </center>
                   ...
                   <Parent label="Address" type="text" name="address"></Parent>
                    <center><h1>*Click the button to go to Child One</h1> </center>
                    <center><input  type = "submit" value = "Child One" className="lgn_btn"/></center>
                </form>
                </div> 
            ); 
    } 
